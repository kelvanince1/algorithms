...
class BrowserHistory {
    ...
    back(steps) {
        ...
        if (steps >= length) return this.history[0];
        
        this.currentPage = this.history.length - steps;
        
        return this.history[this.currentPage-1];
    }
    
    visit(url) {
        this.history.push(url);
        this.currentPage = this.history.length;
    ...
    forward(steps) {
        ...
        if (steps >= length) return this.history[-1];
